...
| **ChIP-seq / ChAP / ChIP-chip**| High-throughput in vivo TF binding datasets (GlxR, GntR1, SigH, DtxR, HrrA, MalR, CgpS, SigC, SigD, OsnR, AmtR). | Toyoda et al. *J. Bacteriol* (2015) DOI:10.1128/JB.02248-14; GEO GSE52040, GSE58633. |
| **GEO TF Perturbations II** | Multi-condition transcriptome series (SigH, IolR, ChrSA, HrrA, SigA, SigC, FMN).                   | Tanaka (2014) DOI:10.1128/JB.01860-14; PMID: 23873914; PMID: 23038807; GEO GSE44812, GSE37327. |
| **RegPrecise**            | Curated prokaryotic transcription factor regulons and motif predictions.                           | Novichkov, P.S. et al. *Nucleic Acids Research* 40, D150–D158 (2012).                                      |
...
| **ChIP-seq / ChAP / ChIP-chip**| 全基因组活体结合数据 (GlxR, GntR1, SigH, DtxR, HrrA, MalR, CgpS, SigC, SigD, OsnR, AmtR)。 | Toyoda (2015) DOI:10.1128/JB.02248-14; GEO GSE52040, GSE58633。 |
| **GEO 基因表达扰动集 II**   | 扩展转录组表达扰动数据集 (SigH, IolR, ChrSA, HrrA, SigA, SigC, FMN)。 | Tanaka (2014) DOI:10.1128/JB.01860-14; PMID: 23873914; PMID: 23038807。 |
| **RegPrecise**          | 原核生物转录因子 Regulon 预测与 Motifs 库。                             | Novichkov, P.S. et al. *Nucleic Acids Research* 40, D150–D158 (2012). |
